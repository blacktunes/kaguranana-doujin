      ...
      <a-list-item :key="item.title">
        ...
        <template v-slot:extra>
          ...
          <img
            ...
            width="272"
            alt="logo"
            src="https://i0.hdslb.com/bfs/article/a264ae7e7b91f7da243bcb3c02ce69219a936bad.jpg@860w_482h.webp"
          />
          </div>
        </template>
...
for (let i = 0; i < 23; i++) {
  listData.push({
    ...
    title: `狗妈月刊 ${i}`,
    avatar: 'https://i0.hdslb.com/bfs/article/a264ae7e7b91f7da243bcb3c02ce69219a936bad.jpg@860w_482h.webp',
    description:
